...
<div class="container">
	...
	<div class="content">
		...
		<form name="form" class="row center-text" action="{{ url('/install/run') }}" method="post" role="form">
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
			<div class="form-section col-sm-6">
				<h2>System settings</h2>
				<p>Some basic settings for the application.</p>
				<div class="form-group">
					<label>Host</label><input type="text" class="form-control" name="host" value="{{ \Input::old('host') ?: $host }}" placeholder="http://www.awesome-server.com" />
					<span class="help-block">Attention: No trailing slash!</span>
				</div>
				<div class="form-group">
					<label>Locale</label>
			...
			<div class="form-section col-sm-6">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="name" value="{{ \Input::old('name') }}" placeholder="Steve">
				</div>

				<div class="form-group">
					<label>E-Mail-Address</label>
					<input type="email" class="form-control" name="email" value="{{ \Input::old('email') }}" placeholder="notch@example.com">
				</div>
